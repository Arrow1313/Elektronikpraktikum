...
Der Code \ref{lst:g_1} wird auf den Mikrocontroller geladen. Danach wird Port B über ein Flachbandkabel mit dem LED Port verbunden. Das Board wird an ein Oszilloskop angeschlossen und die Ausgangsfrequenz an den Pins gemessen.
