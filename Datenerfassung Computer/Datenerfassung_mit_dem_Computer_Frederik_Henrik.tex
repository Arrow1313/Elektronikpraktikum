...
Es werden die vier Ausgänge des Taktzählers mit einem Binären Widerstandnetzwerk sowie Ausgang A mit einem Oszilloskop verbunden.

\subsubsection*{Versuchsdurchführung}
%erklären, !was! wir machen, !warum! wir das machen und mit welchem ziel
%(wichtig) präzize erklären, wie bei dem versuch vorgegangen und was gemacht wurde

Es wird die gleiche Schaltung wie in Abschnitt \ref{sec:binaer_widerstand} verwendet. Der größte Widerstand wird an die erste Binärstelle angschlossen und an jede weitere Binärstelle jeweils die Hälfte des Widerstandes an der Binärstelle davor. Danach wird das Signal mit dem Oszillsokop beobachtet.
...
In diesem Versuchsteil wird ein DAC mit einem R-2R-Netzwerk untersucht.
...
Es wird anstelle des Binärnetzwerks ein R-2R-Netzwerk eingesetzt.
...
In diesem Versuchsteil wird ein ADC mit dem Zählverfahren gebaut, welches leicht zu realisieren, jedoch langsam ist.
...
Das Zusatzboard wird an das Board angeschlossen, beide müssen mit Strom versorgt werden. Das vorgeschriebene Programm wird auf das Board geladen. Danach wird die zu messende Spannung an M1 angeschlossen. Die Funktionalität wird untersucht, indem verschiedene Steuerzeichen an den Mikrocontroller geschickt werden. Dann werden unterschiedliche Spannungen eingestellt und die Ausgangssignale mit dem Oszilloskop beobachtet. Das Bitmuster wird jeweils abgelesen und notiert. Der Vorgang wird für das Zählverfahren und das Approximationsverfahren durchgeführt.
