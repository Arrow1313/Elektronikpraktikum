...
In diesem Versuch sollen verschieden Schaltungen aus den Versuchen zuvor mit Multisim simuliert werden.
...
In diesem Versuchsteil sollte zu erst die Verstärkung durch den Op-Amp untersucht werden, so wie die Abhängigkeit der Verstärkung von den Widerständen R1 und R2. Für R3 = 10k$\Omega$ und R1 = 1k$\Omega$ ergibt sich ein Verstärkung von 193, siehe Abbildung \ref{fig:3_4_ver_std}. Wird R3 auf 1k$\Omega$ reduziert ergibt sich eine Verstärkung von 65, siehe Abbildung \ref{fig:3_4_ver_r3}.

\begin{figure}[H]
        \centering
        \begin{subfigure}[t]{0.48\textwidth}
               \includegraphics[scale = 0.5]{3_4_verstaerkung.PNG}
				\caption[Aufnahme der Ein- und Ausgangsspannung bei R3 = 10k$\Omega$]{Aufnahme der Ein- und Ausgangsspannung bei R3 = 10k$\Omega$}
 				 \label{fig:3_4_ver_std}
        \end{subfigure}%
        %~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
          %(or a blank line to force the subfigure onto a new line)
        \hfill
        \begin{subfigure}[t]{0.48\textwidth}
                \includegraphics[scale = 0.5]{3_4_R3_kleiner.PNG}
  				\caption[Aufnahme der Ein- und Ausgangsspannung bei R3 = 1k$\Omega$]{Aufnahme der Ein- und Ausgangsspannung bei R3 = 1k$\Omega$}
  				\label{fig:3_4_ver_r3}
        \end{subfigure}
        \caption{Kurven zur Messung der Verstärkung}
        \label{fig:3_4_ver}
\end{figure}

Dann wurde untersucht, ab welcher Amplitude sich das Signal verzerrt, dabei wurde die erste Verzerrung bei 50mV aufgenommen, siehe Abbildung \ref{fig:3_4_verzerr}.


\begin{figure}[H] 
  \centering
    \includegraphics[ scale = 0.7]{3_4_verzerrung.PNG}
  	\caption[Erste Verzerrung des Signals bei 50mV]{Erste Verzerrung des Signals bei 50mV}
  \label{fig:3_4_verzerr}
\end{figure}

Zuletzt sollte noch untersucht werden wie sich das Signal bei niedrigen (Abbildung \ref{fig:3_4_frequ_1k}) und bei hohen (Abbildung \ref{fig:3_4_frequ_10M}) Frequenzen verhält. Dabei ist deutlich zu erkennen, das hohe Frequenzen für eine Phasenverschiebung des Signals sorgen.

\begin{figure}[H]
        \centering
        \begin{subfigure}[t]{0.48\textwidth}
               \includegraphics[scale = 0.5]{3_4_frequenz_1k.PNG}
				\caption[Aufnahme des Ein- und Ausgangssignals bei 1kHz]{Aufnahme des Ein- und Ausgangssignals bei 1kHz}
 				 \label{fig:3_4_frequ_1k}
        \end{subfigure}%
        %~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
          %(or a blank line to force the subfigure onto a new line)
        \hfill
        \begin{subfigure}[t]{0.48\textwidth}
                \includegraphics[scale = 0.5]{3_4_frequenz_10M.PNG}
  				\caption[Aufnahme des Ein- und Ausgangssignals bei 10MHz]{Aufnahme des Ein- und Ausgangssignals bei 10MHz}
  				\label{fig:3_4_frequ_10M}
        \end{subfigure}
        \caption{Messung des Signals bei niedrigen und bei hohen Frequenzen}
        \label{fig:3_4_frequ}
\end{figure}
...
Es wurde ein viel größerer Verstärkungsfaktor erwartet und bei der Verkleinerung von R3 um den Faktor 10 hätte sich der Verstärkung auch um den Faktor 10 verringern sollen. Wir können uns nicht erklären wo diese Abweichungen herkommen, da wir nicht die interne Berechnung der Werte kennen. Die Phasenverschiebung war auch beim vorherigem Versuch zu sehen.
...
In diesem Versuchsteil wird die Schaltung eines Integrierers simuliert und ihre Eigenschaften anhand von drei verschiedenen Signalen untersucht.
...
In diesem Versuch wurden verschiedene Schaltungen, welche schon zuvor schon in echt untersucht hatten simuliert. Dabei zeigte sich das Multisim bei allen Schaltungen die zuvor bestimmten Messungen qualitativ reproduzieren konnte. Multisim eignet sich sehr gut, um Schaltungen zu Simulieren und ihr Verhalten zu untersuchen, dabei sollte man jedoch beachten, das Multisim nicht die Zerstörung von Bauteilen mit Simuliert, bei zu hohen Strömen bzw. Spannungen.
