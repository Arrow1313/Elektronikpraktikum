...
\begin{framed}
\noindent
Da es kompikationen bei der installation von ISE gab konnten wir keine eigenen Bilder für die Versuchaufbauten verwenden.
Abbildung \ref{fig:auf_1_1} ist aus der Praktikumsanleitung entnommen und wurde mit Inkscape bearbeitet, um unserem Aufbau zu entsprechen.
Abbildung \ref{fig:auf_1_2} und \ref{fig:auf_1_3} sind von der Gruppe Pagel, Roggel und Reisch, deren Aufbau identisch zu unserem ist.
\end{framed}
...
\begin{figure}[H] 
  \centering 	
    \includegraphics[ scale = 0.2]{Schaltung1.png}
...
Die Werte wurden direkt vom Oszillskop abgelesen.
...
Es wird die Schaltung in Abbildung \ref{fig:auf_1_2} mit ISE aufgebaut und implementiert.

\begin{figure}[H] 
  \centering 	
    \includegraphics[ scale = 0.4]{Schaltung2.jpg}
...
Es wird die Schaltung in Abbildung \ref{fig:auf_1_3} mit ISE aufgebaut und implementiert.

\begin{figure}[H] 
  \centering 	
    \includegraphics[ scale = 0.4]{Schaltung3.JPG}
  	\caption[Schaltskizze des 16fach-Zählers]{Schaltskizze des 16fach-Zählers}
  \label{fig:auf_1_3}
\end{figure}
...
\label{scr:wut}
\caption[Datei zur Festlegung der Pinbelegung]{Datei zur Festlegung der Pinbelegung}
\end{figure}

\begin{figure}[H]
\lstinputlisting[language=Verilog, basicstyle=\tiny]{Verilog_1_iso.v}
\caption[Quellcode für die 1. Aufgabe]{Quellcode für die 1. Aufgabe}
\label{scr:1}
\end{figure}
