...
Für die Signalübertragung über ein twisted-pair Kabel wurde der Aufbau aus Abbildung \ref{fig:2.2} verwendet.
...
Da die Signalquelle nicht Potentialfrei ist verwendet man als Signalquelle in Mikrofon. Das Signal wir über einen Operationsverstärker, siehe Abbildung \ref{fig:2.33} verstärkt, um das Signal auf dem Oszilloskop sichtbar zu machen.
