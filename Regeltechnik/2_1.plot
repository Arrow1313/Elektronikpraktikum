...
#plot "2_1.dat" u (bin($1,binwidth)):(2_1.0) notitle smooth freq with boxes #histogramm plotten
...
plot "2_1.dat" with xyerrorbars title "Messdaten"#, f(x) title "Regression" , g(x) title "Theoriekurve" #, "2_1.dat" smooth csplines title "Messdaten mit csplines" #plotten von messdaten, regression, und csplines
