...
#plot "3_4.dat" u (bin($1,binwidth)):(3_4.0) notitle smooth freq with boxes #histogramm plotten
...
plot "3_4.dat" with xyerrorbars title "Messdaten"#, f(x) title "Regression" , g(x) title "Theoriekurve" #, "3_4.dat" smooth csplines title "Messdaten mit csplines" #plotten von messdaten, regression, und csplines

set terminal postscript eps enhanced color font 'Helvetica,14' #ausgabeformat
set output "3_4.eps" #name des dokuments
replot #dokument plotten
!epstopdf 3_4.eps #eps in pdf umwandeln
