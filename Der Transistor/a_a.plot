...
set xlabel "U_CE/V" #achsenbeschriftung
set ylabel "I_CE/mA"
...
plot "a_a.dat" with xyerrorbars title "Messdaten"#, f(x) title "Regressionsgerade", "Beispiel2.dat" smooth csplines title "Messdaten mit csplines" #plotten von messdaten, regression, und csplines

set terminal postscript eps enhanced color font 'Helvetica,12' #ausgabeformat
set output "a_a.eps" #name des dokuments
replot #dokument plotten

!epstopdf a_a.eps #eps in pdf umwandeln
