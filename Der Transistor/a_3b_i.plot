...
set xlabel "I_B/nA" #achsenbeschriftung
set ylabel "I_R/mA"
...
fit f(x) "a_3b_i.dat" using 1:2:4 via m,b #funktionen fitten

plot "a_3b_i.dat" with xyerrorbars title "Messdaten", f(x) title "Regressionsgerade"#, "Beispiel2.dat" smooth csplines title "Messdaten mit csplines" #plotten von messdaten, regression, und csplines

set terminal postscript eps enhanced color font 'Helvetica,12' #ausgabeformat
set output "a_3b_i.eps" #name des dokuments
replot #dokument plotten

!epstopdf a_3b_i.eps #eps in pdf umwandeln
