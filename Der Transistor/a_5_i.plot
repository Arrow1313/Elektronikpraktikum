...
set xlabel "R_L/Ohm" #achsenbeschriftung
set ylabel "I_A/mA"
...
#fit f(x) "a_5_i.dat" using 1:2:4 via m,b #funktionen fitten

plot "a_5_i.dat" with xyerrorbars title "Messdaten"#, f(x) title "Regressionsgerade"#, "Beispiel2.dat" smooth csplines title "Messdaten mit csplines" #plotten von messdaten, regression, und csplines

set terminal postscript eps enhanced color font 'Helvetica,12' #ausgabeformat
set output "a_5_i.eps" #name des dokuments
replot #dokument plotten

!epstopdf a_5_i.eps #eps in pdf umwandeln
