...
set xlabel "Gewicht/g" #achsenbeschriftung
...
#plot "4_2.dat" u (bin($1,binwidth)):(1.0) notitle smooth freq with boxes #histogramm plotten
...
fit f(x) "4_2.dat" using 1:2:4 via m,b #funktionen fitten
plot "4_2.dat" with xyerrorbars title "Messdaten", f(x) title "Regressionsgerade" #, g(x) title "Theoriekurve" #, "4_2.dat" smooth csplines title "Messdaten mit csplines" #plotten von messdaten, regression, und csplines

set terminal postscript eps enhanced color font 'Helvetica,14' #ausgabeformat
set output "4_2.eps" #name des dokuments
replot #dokument plotten
!epstopdf 4_2.eps #eps in pdf umwandeln
