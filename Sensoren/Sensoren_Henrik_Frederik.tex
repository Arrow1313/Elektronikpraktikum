...
%(immer) eine skizze oder ein foto einfügen, die geräte/materialien !nummerieren! und z.b. eine legende dazu schreiben, besser wäre es das ganze in einem Fließtext gut zu beschreiben.
%falls am anfang des versuches nicht klar ist, was alles verwendet wird, wenn möglich erst am ende ein großes foto von den verwendeten materialien machen!\\
Verwendet wird ein Oszilloskop, ein dynamisches Mikrofon, welches über einen Adapter im ersten Teil direkt an das Oszilloskop angeschlossen wird. Im zweiten Teil werden zusätzlich ein Op-Amp, Bananenkabel, ein \unit[100]{k$\Omega$} Widerstand, ein \unit[100]{nF} Kondensator und zwei \unit[9]{V} Spannungsquellen (Funktionsgenerator) verwendet.
\subsubsection*{Versuchsaufbau}
%skizze zum versuchsaufbau (oder foto) einfügen,   es muss erklärt werden wie das ganze funktioniert und welche speziellen einstellungen verwendet wurden (z.b. welche knöpfe an den geräten für die messung verdreht wurden)
In dieser Schaltung werden die Mikrofonsignale mit dem Op-Amp verstärkt.
\begin{figure}[H] 
  \centering
    \includegraphics[ scale = 0.7]{Auf_5_1.png}
  	\caption[Schaltskizze für das dynamische Mikrofon]{Schaltskizze für das dynamische Mikrofon\footnotemark}
  \label{fig:auf_5_1}
\end{figure}
...
\begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[ scale = 0.4]{TEK0000.pdf}
  	\caption[nichtverstärkte Aufnahme mit dem dynamischen Mikrofon]{nichtverstärkte Aufnahme mit dem dynamischen Mikrofon}
  \label{fig:Oszi_5_1_1}
        \end{subfigure}%
        %~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
          %(or a blank line to force the subfigure onto a new line)
        \hfill
        \begin{subfigure}[b]{0.48\textwidth}
               \includegraphics[ scale = 0.4]{TEK0005.pdf}
  	\caption[verstärkte Pfeifaufnahme mit dem dynamischen Mikrofon]{verstärkte Pfeifaufnahme mit dem dynamischen Mikrofon}
  \label{fig:Oszi_5_1_2}
        \end{subfigure}
        \caption{Pfeifaufnahme mit und ohne Verstärkung}
        \label{fig:Oszi_5_1_Pfeif}
\end{figure}
In Abb. \ref{fig:Oszi_5_1_3} wurde ein Lautsprechersignal aufgenommen und über 128 Werte gemittelt.
Die Spitzenspannung ist kleiner als bei der Pfeifaufnahme, da der Lautsprecher leiser war.
\begin{figure}[H] 
  \centering
    \includegraphics[ scale = 0.7]{TEK0010.pdf}
  	\caption[verstärkte Lautsprecheraufnahme mit dem dynamischen Mikrofon]{verstärkte Lautsprecheraufnahme mit dem dynamischen Mikrofon}
  \label{fig:Oszi_5_1_3}
\end{figure}
Beim verstellen der Frequenz des Lautsprechers war ab ca. \unit[70]{Hz} ein Signal messbar und ab ca. \unit[3]{kHz} brach das Signal zusammen.
...
\subsubsection*{Versuchsaufbau}
%skizze zum versuchsaufbau (oder foto) einfügen,   es muss erklärt werden wie das ganze funktioniert und welche speziellen einstellungen verwendet wurden (z.b. welche knöpfe an den geräten für die messung verdreht wurden)
Der Widerstand stellt einen Spannungsteiler und der Kondensator einen Hochpass dar.(d.h. Gleichspannungen werden herausgefiltert)
\begin{figure}[H] 
  \centering
...
\end{figure}
\footnotetext{Abbildung entnommen von http://www.atlas.uni-wuppertal.de/$\sim$kind/ep6\_14.pdf Seite 11 am 01.12.2014}
Die Impedanzwandlerschaltung  Abb. \ref{fig:auf_5_2_2}, welche aus dem Versuch mit dem Op-Amp bekannt ist, soll die Signalqualität verbessern.
\begin{figure}[H] 
  \centering
    \includegraphics[ scale = 0.7]{Auf_5_2_2.png}
  	\caption[Verstäkerschaltskizze für das Elektretmikrofon]{Verstärkerschaltskizze für das Elektretmikrofon\footnotemark}
  \label{fig:auf_5_2_2}
\end{figure}
\footnotetext{Abbildung entnommen von http://www.atlas.uni-wuppertal.de/$\sim$kind/ep6\_14.pdf Seite 11 am 01.12.2014}
...
\begin{figure}[H]
        \centering
        \begin{subfigure}[b]{0.48\textwidth}
                \includegraphics[ scale = 0.4]{TEK0002.pdf}
  	\caption[nichtverstärkte Aufnahme mit dem dynamischen Mikrofon]{nichtverstärkte Aufnahme mit dem dynamischen Mikrofon}
  \label{fig:Oszi_5_2_1}
        \end{subfigure}%
        %~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
          %(or a blank line to force the subfigure onto a new line)
        \hfill
        \begin{subfigure}[b]{0.48\textwidth}
               \includegraphics[ scale = 0.4]{TEK0006.pdf}
  	\caption[verstärkte Pfeifaufnahme mit dem Elektret-Mikrofon]{verstärkte Pfeifaufnahme mit dem Elektret-Mikrofon}
  \label{fig:Oszi_5_2_2}
        \end{subfigure}
        \caption{Pfeifaufnahme mit und ohne Verstärkung}
        \label{fig:Oszi_5_2_Pfeif}
\end{figure}
In Abb. \ref{fig:Oszi_5_2_3} wurde ein Lautsprechersignal aufgenommen und über 128 Werte gemittelt.
\begin{figure}[H] 
  \centering
    \includegraphics[ scale = 0.7]{TEK0009.pdf}
  	\caption[verstärkte Lautsprecheraufnahme mit dem Elektret-Mikrofon]{verstärkte Lautsprecheraufnahme mit dem Elektret-Mikrofon}
  \label{fig:Oszi_5_2_3}
\end{figure}
Beim verstellen der Frequenz des Lautsprechers war ab ca. \unit[70]{Hz} ein Signal messbar und ab ca. \unit[3,5]{kHz} brach das Signal zusammen.
...
Wie erwartet wurde das Signals mit dem Impedanzwander verbessert. Das Elektret-Mikrofon arbeitet ab einer Frequenz von ca. \unit[70]{Hz} und das Signal bricht bei ca. \unit[3,5]{kHz} zusammen.
...
Der Funktionsgenerator, die Spule und der Feuchtigkeitssensor werden in reihe geschaltet. Das Oszilloskop wird parallel zum Feuchtigkeitssensor geschaltet.
...
\begin{figure}[H] 
  \centering
    \includegraphics[ scale = 0.5]{6_1.pdf}
  	\caption[Aufnahme des Oszilloskops bei Raumluftfeuchtigkeit]{Aufnahme des Oszilloskops bei Raumluftfeuchtigkeit}
  \label{fig:6_1}
\end{figure}
...
\begin{figure}[H] 
  \centering
    \includegraphics[ scale = 0.5]{6_2.pdf}
  	\caption[Aufnahme des Oszilloskops nach längerem Anhauchen des Luftfeuchtigkeitssensors]{Aufnahme des Oszilloskops nach längerem Anhauchen des Luftfeuchtigkeitssensors}
  \label{fig:6_2}
\end{figure}
